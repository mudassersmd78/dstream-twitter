...
spName := "org.spark-project/dstream-twitter"
...
pomExtra :=
  <url>https://github.com/spark-packages/dstream-twitter</url>
  <scm>
    <url>git@github.com:spark-packages/dstream-twitter.git</url>
    <connection>scm:git:git@github.com:spark-packages/dstream-twitter.git</connection>
  </scm>
  <developers>
    <developer>
      <id>marmbrus</id>
